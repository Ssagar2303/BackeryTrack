...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1450,height=120,bg="#B22C73")
        self.topframe.place(x=0,y=0)
        self.store_name = 'Tha Cafe'
        self.storelable=Label(self.topframe,text=self.store_name + " Sales & Inventory System",bg="#B22C73",anchor="center")
        ...
        ''''
        if self.account_type == 'ADMIN':
            self.adminlabel= Label(self.topframe,text="Admin",font="Roboto 10 bold",bg="#B22C73")
        else:
            self.adminlabel = Label(self.topframe, text=" User", font="Roboto 10 bold", bg="#B22C73")
