...
class Login:
    ...
    # WIDGET FUNCTION
    def obj(self):
        self.loginframe=LabelFrame(self.loginw,bg="#B22C73",height=400,width=400)
        self.loginw.bind('<Return>',self.checkuser)
        self.loginframe.place(x=103,y=95)
        self.toplabel = Label(self.loginframe, fg="white", bg="#B22C73", anchor="center", text="Login", font="Roboto 40 bold")
